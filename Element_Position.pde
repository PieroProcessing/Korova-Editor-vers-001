...
void FFSliderPosition() {
  for (int i=16; i<20; i++) {
    elementData.add(new myUI(this, cp5, "F"+(i-16), memPosLUT[i], i, gridCols[3]*3.3+(i-16)*spaceBetw, gridRow[8]+spaceBetw*4 + random(50), rW, rH-34, 0));
  }
}
void buttPosition() {
...
void lateralButton() {
  elementData.add(new myUI(this, cp5, "B26", memPosLUT[44], 44, gridCols[3]-rW/3, gridRow[8], rW, rH, 1));
  elementData.add(new myUI(this, cp5, "B27", memPosLUT[45], 45, gridCols[3]-rW/3, gridRow[6]+spaceBetw*4, rW, rH, 1));
  elementData.add(new myUI(this, cp5, "B25", memPosLUT[46], 46, gridCols[3]-rW/3, gridRow[11]+spaceBetw*3, rW+5, rH+5, 1));
  ...
  elementData.add(new myUI(this, cp5, "B32", memPosLUT[51], 51, gridCols[3]+ 9*spaceBetw, gridRow[9], rW, rH, 1));
}
void JTPosition() {
  elementData.add(new myUI(this, cp5, "J2", memPosLUT[52], 52, gridCols[3]-rW/2, gridRow[6]+spaceBetw*2, rW+15, rH+15, 2));
  elementData.add(new myUI(this, cp5, "T2", memPosLUT[53], 53, gridCols[3]-rW/5, gridRow[6]+spaceBetw*3, rW-20, rH-20, 0));
}

void JoyStick() {
  elementData.add(new myUI(this, cp5, "JY", memPosLUT[54], 54, gridCols[4], gridRow[8]+spaceBetw*4+2*rH, rW, rH/2, 0));
  elementData.add(new myUI(this, cp5, "JX", memPosLUT[55], 55, gridCols[5]+spaceBetw/3, gridRow[8]+spaceBetw*4+2*rH, rW, rH/2, 0));
  elementData.add(new myUI(this, cp5, "JB", memPosLUT[56], 56, gridCols[4]+spaceBetw-20, gridRow[8]+spaceBetw*5+rH/3, rW-30, rH-30, 1));
  //elementData.add(new myUI(this, cp5, "Pads", memPosLUT[43], 43,  rW*8/9, rH/2, 0));
}
void PageSwitch() {
  elementData.add(new myUI(this, cp5, "Switch", memPosLUT[57], 57, gridCols[3]+4*spaceBetw+rW/2, gridRow[8]+spaceBetw*4+2*rH, rW*11/12+rW/2, rH/2, 0));
  elementData.add(new myUI(this, cp5, "Mouse", memPosLUT[58], 58, gridCols[3]+3*spaceBetw+8, gridRow[8]+spaceBetw*4+2*rH, rW*11/12+rW/2, rH/2, 0));
}
